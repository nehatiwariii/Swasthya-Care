...
import logo from "../../../images/taru.png";
const Navbar = () => {
      ...
      <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul className="navbar-nav ml-auto" style={{ fontSize: " 1.42em" }}>
          ...
          <li className="nav-item">
            <Link className="nav-link mr-5 text-dark" to="/login">
              Login
            </Link>
          </li>
          ...
          <li className="nav-item">
            <Link
              className="nav-link mr-5 text-dark"
          ...
          <li className="nav-item">
            <Link className="nav-link mr-5 text-white" to="/appointment">
              Appointment
            </Link>
          </li>
